...
public class HeadServerHandler implements IDataHandler, IConnectHandler,
	...
	public boolean onConnect(INonBlockingConnection connection)
		...
		ServerUtil.getInstance()
				.sendCommand(connection, "FF 01 00 51 00 00 52");
	...
	public boolean onData(INonBlockingConnection connection)
		...
		if (connection != null && connection.isOpen()) {
			...
			if (s.indexOf("FF010059") > -1) {
				float angle_x = (float) Integer
						.parseInt(s.substring(8, 12), 16) / 100;
	...
	public static void main(String[] args) throws Exception {
		IServer srv = null;
		try {
			InetAddress address = InetAddress.getByName("192.168.254.111");
