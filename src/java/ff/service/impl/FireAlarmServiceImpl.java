...
//得到火警信息
    ...
    public String getFireAlarmList(Long ptzId, Timestamp beginTime, Timestamp endTime) {
        ...
        //这是需要过滤掉的变量名。
        jsonConfig.setExcludes(new String[]{ "rolesPrivilegeDetails", "fireAlarm","role","rolePtz","ignoreAreas"});
...
//得到某一个火警信息JSON
    ...
    public String getFireAlarmJSONById(Long id) {
        ...
        JsonConfig jsonConfig = new JsonConfig();
        jsonConfig.setExcludes(new String[]{"fireAlarm","rolesPrivilegeDetails", "fireAlarm","role","rolePtz","ignoreAreas"});
        jsonConfig.registerJsonValueProcessor(Timestamp.class, new DateJsonValueProcessor("yyyy-MM-dd HH:mm:ss"));
