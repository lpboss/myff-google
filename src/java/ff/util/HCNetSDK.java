...
//通道压缩参数(9000扩展)
    ...
    public static class NET_DVR_RECORD extends Structure { //通道录像参数配置
        ...
        public NET_DVR_RECORDSCHEDWEEK[] struRecordSched = new NET_DVR_RECORDSCHEDWEEK[MAX_DAYS];
        public int dwRecordTime;	/*
         * 录象时间长度 0-5秒， 1-20秒， 2-30秒， 3-1分钟， 4-2分钟， 5-5分钟， 6-10分钟
         */
...
//云台协议表结构配置
    ...
    public static class NET_DVR_RS232CFG_V30 extends Structure {//RS232串口参数配置(9000扩展)
         ...
         * 目前只有第一个串口设置有效，所有设备都只支持一个串口，其他七个保留
         */
    ...
    public static class NET_DVR_ALARMINFO extends Structure {
         ...
         * 触发的录像通道，dwAlarmRelateChannel[0]为1表示第1个通道录像
         */
    ...
    public static class NET_DVR_ALARMINFO_EX extends Structure {//上传报警信息(杭州竞天定制 2006-07-28)
        ...
        public int[] dwAlarmOutputNumber = new int[MAX_ALARMOUT];/*
         * 报警输入端口对应的输出端口，哪一位为1表示对应哪一个输出
         */

        public int[] dwAlarmRelateChannel = new int[MAX_CHANNUM];/*
         * 报警输入端口对应的录像通道，哪一位为1表示对应哪一路录像,dwAlarmRelateChannel[0]对应第1个通道
         */

        public int[] dwChannel = new int[MAX_CHANNUM];/*
         * dwAlarmType为2或3,6时，表示哪个通道，dwChannel[0]位对应第0个通道
         */
...
//日志信息
    ...
    public static class NET_DVR_FRAMEFORMAT_V30 extends Structure {//ATM参数(9000扩展)
         ...
         * 卡号捕捉端口号(网络协议方式) (保留)0xffff表示该值无效
         */

        public short wProtocolType;						/*
         * 网络协议类型(保留) 0xffff表示该值无效
         */
...
//2005-08-01
    ...
    /*
     * https://jna.dev.java.net/javadoc/com/sun/jna/Union.html#setType(java.lang.Class)
     * see how to use the JNA Union
     */
...
//叠加字符
    ...
    public static class NET_DVR_EMAILCFG_V30 extends Structure {
        ...
        public byte[] sSmtpServer = new byte[MAX_EMAIL_ADDR_LEN];	/*
         * smtp服务器
         */

        public byte[] sPop3Server = new byte[MAX_EMAIL_ADDR_LEN];	/*
         * pop3服务器
         */
...
//ddns
    ...
    public static class NET_DVR_DDNSPARA_EX extends Structure {
         ...
         * 0-Hikvision DNS 1－Dyndns 2－PeanutHull(花生壳), 3-希网3322
         */
...
//手动查看 2007-12-28
    public static class NET_DVR_MATRIX_ROW_COLUMN_LINK extends Structure {
         ...
         */
        public int dwRowNum;			/*
         * -1代表无效域,大于0者方为有效的矩阵行号
         */

        public byte[] sSurvChanName = new byte[128];	/*
         * 监控通道名,是否无效按字符串的有效性判断
         */

        public int dwSurvNum;			/*
         * 监控通道号,按矩阵行列表的顺序指定，一般情况下与行号一致
         */
        /*
    ...
    public static class NET_DVR_MATRIX_LOCAL_HOST_INFO extends Structure {//矩阵中心配置 2007-12-28
         ...
         * 控制方式 0x1串口键盘控制 0x2网络键盘控制 0x4矩阵中心控制 0x8PC客户端控制
         */
