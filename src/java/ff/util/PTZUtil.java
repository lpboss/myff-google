    ...
    public static void PTZAction(String ptzAction) {
        ...
        try {
            if (ptzAction.equals("up")) {
                ServerUtil.getInstance().sendCommand("192.168.254.65", "FF 01 00 08 00 3F 48");
                logger.info("FF 01 00 08 00 3F 48 UP...........................");
            } else if (ptzAction.equals("down")) {
                ServerUtil.getInstance().sendCommand("192.168.254.65", "FF 01 00 10 00 3F 50");
                logger.info("FF 01 00 10 00 3F 50 DOWN.........................");
            } else if (ptzAction.equals("right")) {
                ServerUtil.getInstance().sendCommand("192.168.254.65", "FF 01 00 02 3F 00 42");
                logger.info("FF 01 00 02 3F 00 42 RIGHT........................");
            } else if (ptzAction.equals("left")) {
                ServerUtil.getInstance().sendCommand("192.168.254.65", "FF 01 00 04 30 00 35");
                logger.info("FF 01 00 04 30 00 35 LEFT.........................");
            } else if (ptzAction.equals("stop")) {
                ServerUtil.getInstance().sendCommand("192.168.254.65", "FF 01 00 00 00 00 01");
