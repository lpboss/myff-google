...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/javascript">
        ...
        function regIPC(deviceIP){
            //
            m_bDVRControl = document.getElementById("visiblePlayer");
            m_iLoginUserId = m_bDVRControl.Login(deviceIP,"8000","admin","12345");
            if(m_iLoginUserId == -1)
            {
                alert("注册失败！");
            }
        ...
        function showIPC(deviceIP){            
            regIPC(deviceIP);
            var bRet = m_bDVRControl.StartRealPlay(1,1,1);		
        ...
        //切换监控通道
        function setChannel(id,ptzControlIP,ptzAlertIP,visibleRTSPUrl,infraredRTSPUrl,gisMapUrl,visibleCameraUrl){
            ptz_id=id;
    ...
    <div class="nav">
        <div class="daohang">  
            <ul>
                ...
                <li><a href="<%=basePath%>record/recordSearch.htm" title="录像查询"  target="_blank" >录像查询</a></li>
                <li><a title="用户管理" onclick="javascript:window.open('<%=basePath%>index/index2.htm','admin')">用户管理</a></li>
                <li><a title="系统设置" onclick="javascript:window.open('<%=basePath%>index/index2.htm','admin')">系统设置</a></li>
                    ...
                    <div class="ScrCont">      
                        <div id="List1_1">
                            <c:forEach items="${ptzs}" var="ptz"> 
                                <div class=box><a href="javascript:setChannel(${ptz.id},'${ptz.pelcodCommandUrl}','${ptz.infraredCircuitUrl}','${ptz.visibleRTSPUrl}','${ptz.infraredRTSPUrl}','${ptz.gisMapUrl}','${ptz.visibleCameraUrl}');">${ptz.name}</a></div>
                            </c:forEach>
